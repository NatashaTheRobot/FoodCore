...
#define FS2_OAUTH_KEY    (@"3B3MMGET441LFXSWONZ02R3R3O0AIPPMXNRUEQ3JB1AGRVWR")
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (@"HDIWNFOZTFNLY1CBWJQOULGZ5RF3ZL4UZYDKS3PIJ4QPL4HZ")
#endif

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#ifndef FS2_REDIRECT_URL
#define FS2_REDIRECT_URL @"app://foodcore"
#endif
